...
public final class BinaryStdIn {
    ...
    public static void setIn(BufferedInputStream bufferedInputStream) {
        BinaryStdIn.in = bufferedInputStream;
        fillBuffer();
    }
...
//    }
     ...
     * @throws RuntimeException Argument if there are fewer than 64 bits available on standard input
     */
